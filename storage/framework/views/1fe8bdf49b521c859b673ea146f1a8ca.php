...
<div
    ...
    style="
        aspect-ratio:16/9;
        background-image:url('<?php echo e(asset('images/BEE.gif')); ?>');
      ...
      <div class="flex justify-center -mt-12 relative z-10">
        ...
        <div class="grid md:grid-cols-2 gap-10 p-10">
            ...
            <div class="relative">
             ...
             <img
                 src="<?php echo e(asset('images/class pplg1.jpg')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\WINDOWS 11\lily-web\resources\views/home.blade.php ENDPATH**/ ?>