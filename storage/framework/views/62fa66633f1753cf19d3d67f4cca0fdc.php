...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/WEBSITE SEDERHANA PORTOFOLIO.jpg')); ?>"
    ...
    <img src="<?php echo e(asset('project/WEBSITE PORTOFOLIO .jpg')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
    ...
    <img src="<?php echo e(asset('project/PROJECT SENDIRI UANGKAS.jpg')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/NILAI SISWA APK.png')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/JAVA DATA OBAT.jpg')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/CRUD PHP.jpg')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/BANK FLUTTER .png')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/DATA SISWA & GURU CRUD LARAVEL.jpg')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<div class="project-card bg-white/70 backdrop-blur-lg border border-purple-100 p-5 rounded-[30px] shadow-xl">
    ...
    <img src="<?php echo e(asset('project/GAMES.jpg')); ?>"
         class="w-full h-48 object-cover rounded-2xl">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\WINDOWS 11\lily-web\resources\views/projects.blade.php ENDPATH**/ ?>